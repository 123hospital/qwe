...
struct  data_struct26{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor26ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor26_array:[data_struct26] = Array()
...
extension doctor26ViewController{
    func load_data26() {

        Alamofire.request("http://www.ktgh.com.tw/web/ortho/").responseString { response in
            if let html = response.result.value{
                self.parsehtml26(html)
            }
        }
    }
    func parsehtml26(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 2...2{
            ...
            for rate in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[2]/text()[1]"){
                    //*[@id="Table10"]/tbody/tr/td/table[2]/tbody/tr/td/p[2]/text()[1]
            ...
            for k in 3...3{
                for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[\(k)]/font[2]/text()"){
                   
                    //*[@id="Table10"]/tbody/tr/td/table[2]/tbody/tr/td/p[3]/font[2]/text()
                    gg = rate.text! as NSString
...
extension doctor26ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor26_array.count > 0 {
            return doctor26_array.count
        }else{
               return 0
        }
