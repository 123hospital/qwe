...
struct  data_struct17{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor17ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor17_array:[data_struct17] = Array()
...
extension doctor17ViewController{
    ...
    func parsehtml17(_ html1:String)  {
        ...
        for i in 1...1{
            ...
            for k in 4...4{
                for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[\(k)]/span/font"){
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[4]/span/font
                    gg = rate.text! as NSString
...
extension doctor17ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor17_array.count > 0 {
            return doctor17_array.count
        }else{
               return 0
        }
