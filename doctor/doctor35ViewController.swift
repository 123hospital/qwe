// 光田 一般內科 曾士婷 name,experience
import UIKit
import Alamofire
import Kanna

struct  data_struct35{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor35ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor35_array:[data_struct35] = Array()
...
extension doctor35ViewController{
    func load_data35() {
        ...
        Alamofire.request("http://www.ktgh.com.tw/HRE_VSDPT_Look.asp?CatID=120&ModuleType=Y&NewsID=15").responseString { response in
            if let html = response.result.value{
                self.parsehtml35(html)
            }
        }
    }
    func parsehtml35(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 9...9{
            for rate1 in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/font/strong/text()"){
                //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[9]/tbody/tr/td[1]/font/strong/text()
            ...
            for j in 1...1{
                for rate in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/ul/text()[\(j)]"){
                    //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[9]/tbody/tr/td[1]/ul/text()[1]
            ...
            for k in 10...10{
                for rate2 in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/ul/text()[\(k)]"){
                    //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[9]/tbody/tr/td[1]/ul/text()[10]
...
extension doctor35ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor35_array.count > 0 {
            return doctor35_array.count
        }else{
               return 0
        }
