...
struct  data_struct10{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor10ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor10_array:[data_struct10] = Array()
...
extension doctor10ViewController{
    func load_data10() {

        Alamofire.request("http://www.ktgh.com.tw/web/Gastroenterology/").responseString { response in
            if let html = response.result.value{
                self.parsehtml10(html)
            }
        }
    }
    func parsehtml10(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 2...2{
            for rate1 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[1]/strong"){
                //*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[1]/strong
            ...
            for rate in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/ol"){
                    //*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/ol
            ...
            for k in 4...4{
                for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[\(k)]/font"){
                    //*[@id="Table10"]/tbody/tr/td/table[2]/tbody/tr/td/p[4]/font
                    gg = rate.text! as NSString
...
extension doctor10ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor10_array.count > 0 {
            return doctor10_array.count
        }else{
               return 0
        }
