...
class doctor2ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor2_array:[data_struct2] = Array()
...
extension doctor2ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor2_array.count > 0 {
            return doctor2_array.count
        }else{
               return 0
        }
