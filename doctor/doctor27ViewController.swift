...
struct  data_struct27{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor27ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor27_array:[data_struct27] = Array()
...
extension doctor27ViewController{
    func load_data27() {

        Alamofire.request("http://www.ktgh.com.tw/web/TCM/").responseString { response in
            if let html = response.result.value{
                self.parsehtml27(html)
            }
        }
    }
    func parsehtml27(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 2...2{
            for rate1 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[2]/strong"){
                ...
                //*[@id="Table10"]/tbody/tr/td/table[2]/tbody/tr/td/p[2]/strong
            ...
            for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/ul"){
                ...
                //*[@id="Table10"]/tbody/tr/td/table[2]/tbody/tr/td/ul
...
extension doctor27ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor27_array.count > 0 {
            return doctor27_array.count
        }else{
               return 0
        }
