...
struct  data_struct43{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor43ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor43_array:[data_struct43] = Array()
...
extension doctor43ViewController{
    func load_data43() {

        Alamofire.request("http://www.ktgh.com.tw/web/TCM/").responseString { response in
            if let html = response.result.value{
                self.parsehtml43(html)
            }
        }
    }
    func parsehtml43(_ html1:String)  {
        var gg:NSString = " "
        var  doc = try? Kanna.HTML(html: html1, encoding: String.Encoding.utf8)
        var s = data_struct43()
        for i in 6...6{
            for rate1 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[2]/strong"){
                //*[@id="Table10"]/tbody/tr/td/table[6]/tbody/tr/td/p[2]/strong
            ...
            for rate in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/ol"){
                    ...
                    //*[@id="Table10"]/tbody/tr/td/table[6]/tbody/tr/td/ol
                gg = rate.text! as NSString
                s.d_experience = gg.replacingOccurrences(of: " ", with: "")
            }
                
            for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/ul"){

                //*[@id="Table10"]/tbody/tr/td/table[6]/tbody/tr/td/ul
...
extension doctor43ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor43_array.count > 0 {
            return doctor43_array.count
        }else{
               return 0
        }
