// 光田 一般外科 蘇劍秋 name,experience
import UIKit
import Alamofire
import Kanna

struct  data_struct39{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor39ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor39_array:[data_struct39] = Array()
...
extension doctor39ViewController{
    func load_data39() {
        ...
        Alamofire.request("http://www.ktgh.com.tw/HRE_VSDPT_Look.asp?CatID=120&ModuleType=Y&NewsID=22").responseString { response in
            if let html = response.result.value{
                self.parsehtml39(html)
            }
        }
    }
    func parsehtml39(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 1...1{
            ...
            for k in 6...6{
                for rate2 in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/ul/text()[\(k)]"){
                    ...
                    //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[1]/tbody/tr/td[1]/ul/text()[6]
...
extension doctor39ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor39_array.count > 0 {
            return doctor39_array.count
        }else{
               return 0
        }
