// 童綜合 兒童醫學部 小兒過敏免疫科 王銘甫 醫師
import UIKit
import Alamofire
import Kanna

struct  data_struct48{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor48ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    
    var doctor48_array:[data_struct48] = Array()
...
extension doctor48ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor48_array.count > 0 {
            return doctor48_array.count
        }else{
               return 0
        }
