...
class doctor3ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor3_array:[data_struct3] = Array()
...
extension doctor3ViewController{
    func load_data3() {

        Alamofire.request("http://www.ktgh.com.tw/web/ENT/").responseString { response in
            if let html = response.result.value{
                self.parsehtml3(html)
            }
        }
    }
    func parsehtml3(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 1...1{
            ...
            for rate in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[3]/span[2]"){
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[3]/span[2]
            ...
            for k in 13...13{
                for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[\(k)]/span"){
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[13]/span
                    gg = rate.text! as NSString
...
extension doctor3ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor3_array.count > 0 {
            return doctor3_array.count
        }else{
               return 0
        }
