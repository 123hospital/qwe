...
class doctor7ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor7_array:[data_struct7] = Array()
...
extension doctor7ViewController{
    func load_data7() {

        Alamofire.request("http://www.ktgh.com.tw/HRE_VSDPT_Look.asp?CatID=120&ModuleType=Y&NewsID=8").responseString { response in
            if let html = response.result.value{
                self.parsehtml12(html)
            }
        }
    }
    func parsehtml7(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 2...2{
            ...
            for k in 4...4{
                for rate2 in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/ul/text()[\(k)]"){
                    ...
                    //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[2]/tbody/tr/td[1]/ul/text()[4]
...
extension doctor7ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor7_array.count > 0 {
            return doctor7_array.count
        }else{
               return 0
        }
