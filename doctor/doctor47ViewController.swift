// 光田 身心科 溫偉鈞 name,experience
import UIKit
import Alamofire
import Kanna

struct  data_struct47{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor47ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor47_array:[data_struct47] = Array()
...
extension doctor47ViewController{
    func load_data47() {

        Alamofire.request("http://www.ktgh.com.tw/HRE_VSDPT_Look.asp?CatID=120&ModuleType=Y&NewsID=18").responseString { response in
            if let html = response.result.value{
                self.parsehtml47(html)
            }
        }
    }
    func parsehtml47(_ html1:String)  {
        var gg:NSString = " "
        ...
        for i in 1...1{
            ...
            for k in 11...11{
                for rate2 in doc!.xpath("//*[@id=\"Sizebox\"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[\(i)]/tbody/tr/td[1]/ul/text()[\(k)]"){
                    ...
                    //*[@id="Sizebox"]/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/table[1]/tbody/tr/td[1]/ul/text()[11]
...
extension doctor47ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor47_array.count > 0 {
            return doctor47_array.count
        }else{
               return 0
        }
