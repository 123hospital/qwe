...
struct  data_struct30{
    var d_name:String = ""
    var d_experience:String = ""
    var d_skill:String = ""
    var d_license:String = ""
}
class doctor30ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor30_array:[data_struct30] = Array()
...
extension doctor30ViewController{
    func load_data30() {

        Alamofire.request("http://www.ktgh.com.tw/web/Nephrology/").responseString { response in
            if let html = response.result.value{
                self.parsehtml30(html)
            }
        }
    }
    func parsehtml30(_ html1:String)  {
        var gg:NSString = " "
        var  doc = try? Kanna.HTML(html: html1, encoding: String.Encoding.utf8)
        var s = data_struct30()
        for i in 1...1{
            for rate1 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[1]/font/font/strong"){
                //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[1]/font/font/strong
                gg = rate1.text! as NSString
                s.d_name = gg as String
                
                
            for rate in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[3]"){
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/ol
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[3]
            ...
            for k in 16...16{
                for rate2 in doc!.xpath("//*[@id=\"Table10\"]/tbody/tr/td/table[\(i)]/tbody/tr/td/p[\(k)]/span/font/font/text()"){
                    //*[@id="Table10"]/tbody/tr/td/table[1]/tbody/tr/td/p[16]/span/font/font/text()
...
extension doctor30ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor30_array.count > 0 {
            return doctor30_array.count
        }else{
               return 0
        }
