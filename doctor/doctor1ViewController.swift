...
class doctor1ViewController: UIViewController {

    @IBOutlet weak var tableview_doctor: UITableView!
    var doctor1_array:[data_struct1] = Array()
...
extension doctor1ViewController: UITableViewDelegate,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if  doctor1_array.count > 0 {
            return doctor1_array.count
        }else{
               return 0
        }
